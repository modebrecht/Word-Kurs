...
def toolbar_preview(path: Path):
    ...
    d.rounded_rectangle((985, 218, 1195, 270), radius=10, fill='#17324D')
    d.text((1010, 232), 'Dunkelblau', font=f_small, fill='white')
    d.rounded_rectangle((1215, 218, 1410, 270), radius=10, fill='#237B78')
    d.text((1270, 232), 'Blau', font=f_small, fill='white')
