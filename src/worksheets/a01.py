...
def toolbar_preview(path: Path):
    ...
    d.text((985, 184), 'Farben für A1:', font=f_small, fill='#667684')
    d.rounded_rectangle((985, 226, 1025, 266), radius=6, fill='#17324D')
    d.text((1040, 232), 'Dunkelblau', font=f_small, fill='#17324D')
    d.rounded_rectangle((1215, 226, 1255, 266), radius=6, fill='#237B78')
    d.text((1270, 232), 'Blau', font=f_small, fill='#17324D')
